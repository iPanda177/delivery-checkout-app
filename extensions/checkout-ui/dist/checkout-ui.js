...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    const [shippingRulesState, setShippingRulesState] = (0, import_react16.useState)(null);
    const [productsTags, setProductsTags] = (0, import_react16.useState)(null);
    const [haveLTLTag, setHaveLTLTag] = (0, import_react16.useState)(false);
    const [shipmentChoice, setShipmentChoice] = (0, import_react16.useState)("front-door");
    console.log("update");
    ...
    (0, import_react16.useEffect)(() => {
      if (!productsTags) {
        ...
        lines.forEach((line) => {
          ...
          productTagsArray.push(__spreadProps(__spreadValues({}, productData), { lineId: line.id }));
        });
        setProductsTags(productTagsArray);
      }
    }, [productsTags]);
    const checkRules = (zip2) => __async(this, null, function* () {
      const { shippingRules } = yield fetch(`${APP_URL}/app/check-rules`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
        body: JSON.stringify({ zip: zip2 })
    ...
    return (
      // haveLTLTag && (
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(InlineStack2, { minInlineSize: "fill", minBlockSize: "fill", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
        ChoiceList2,
        {
          name: "shipment",
          variant: "group",
