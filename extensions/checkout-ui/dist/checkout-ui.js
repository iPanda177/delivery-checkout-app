...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    console.log(lines);
    const [shipments, setShipments] = (0, import_react29.useState)([]);
    const [deliveryProduct, setDeliveryProduct] = (0, import_react29.useState)(null);
    const [selectedButton, setSelectedButton] = (0, import_react29.useState)(null);
    const [shipmentChoice, setShipmentChoice] = (0, import_react29.useState)("none");
    const [destinationTypeForm, setDestinationTypeForm] = (0, import_react29.useState)({});
    ...
    const getShipmentData = (zip2) => __async(this, null, function* () {
      ...
      yield Promise.all(lines.map((line) => __async(this, null, function* () {
        ...
        if (shipment) {
          const res = yield applyCartLinesChange({
            type: "updateCartLine",
            id: line.id,
            attributes: [{
              key: "ETA",
  ...
  function PhoneConfirmation() {
    ...
    const [phoneConfirmValue, setPhoneConfirmValue] = (0, import_react30.useState)("");
  ...
  function TrustedLogos() {
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(InlineStack2, { spacing: "none", children: [
